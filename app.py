...
# === Page 2: Study Introduction ===
    ...
    st.write("We are going to show you 21 images that were generated by AI of robots.")
...
# === Page 4: Experiment ===
    ...
    if st.session_state.image_index < len(st.session_state.selected_images):
        ...
        with st.form(f"form_{st.session_state.image_index}"):
            ...
            all_rated = all(r is not None for r in [realistic, friendly, scary])
...
# === Page 5: Thank You & Prolific Completion ===
